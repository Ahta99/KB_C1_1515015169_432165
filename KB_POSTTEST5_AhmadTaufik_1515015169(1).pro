...
GOAL
 ...
 /*
 Analisis
 write digunakan untuk menampilkan
 fail digunakan untuk memaksa lacak balik,kenapa ? karena disini beda aturan jadi tidak akan lacak balik, jadi dengan fail akan kembali ke atas untuk lacak balik
 write variable pertama dan kedua dari fakta cetak_orang, cetak orang adalah data object jamak yg berisi orang(Pertama,Kedua), prolog akan mencari data dari variable pertama dan kedua dengan fakta yg ada
 Di dapatkan variable bul = bulan1, yg berarti bulan_ini adalah bul
 dengan deklarasi date adalah tanggal pada sistem komputer jadi hasil dari variabel pertama dan kedua adalah data dari fakta di akumulasikan dengan date komputer
 readchar digunakan untuk membaca karakter kemudian melanjutkan proses
